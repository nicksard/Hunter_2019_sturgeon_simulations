...
#ABOUT: This script was written to compare the know pedigree to the inferred from COLONY

#setting the directory
setwd("C:/Users/sard/Google Drive/R/Data analysis/2019/St Clair Sturgeon/Post processing test")
...
#setwd("C:/Users/sardnich/Documents/Research/R/Data analysis/2017/Manistee River/Postprocessing/")

#reading in the pedigree
df <- read.table(file = "Input/BestConfig.1.txt",header=T,stringsAsFactors = F)
...
#doing the same thing for know parents
...
x %>% spread(key = est.type,value = ns,fill = 0)
